...
addRealQuote("Nobody knew that health care could be so complicated.", "Real. February 2017.")
addRealQuote("Person, woman, man, camera, TV.", "Real. Fox News interview, July 2020.")
...
addRealQuote("I consider firing everybody.", "Real. Joke line during Press Conference. 2020.")
...
addFakeQuote("I know more about ketchup than anyone - it's a very complicated thing, very underrated.")
...
addFakeQuote("I invented the phrase 'extra crispy' - and everybody knows it.")
...
addFakeQuote("I don't blame the coffee; I blame the cup. Some cups are very dishonest cups.")
...
addFakeQuote("Some staplers are total disasters. Mine would staple so beautifully you'd frame it.")
addFakeQuote("I like clocks that tell the truth. Some clocks, believe me, they lie about time.")
...
addFakeQuote("The hotel towels were perfect. Soft, thick, serious towels.")
